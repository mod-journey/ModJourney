...
let change_rods = (event) => {
    ...
    ato.alloy.concat(ato.metall,ato.vanilla).forEach(metal => {
        thermal_press(event, `forge:ingots/${metal}`,1,`alltheores:${metal}_rod`,1,ato.mold.rod,`thermal/rod/${metal}`)
        immersive_press(event, `forge:ingots/${metal}`,1,`alltheores:${metal}_rod`,1,2400,ato.mold.rod,`immersive/rod/${metal}`)
    ...
    ato.gems.forEach(metal => {
        thermal_press(event, `forge:gems/${metal}`,1,`alltheores:${metal}_rod`,1,ato.mold.rod,`thermal/rod/${metal}`)
        immersive_press(event, `forge:gems/${metal}`,1,`alltheores:${metal}_rod`,1,2400,ato.mold.rod,`immersive/rod/${metal}`)
